with Yada.Streams;
with Yada.Sources;
private with Yada.Lexing;
private with Yada.Events;
private with Yada.Strings;
private with Yada.Stacks;

package Yada.Parsing is
   pragma Preelaborate;
...
private
   ...
   package Level_Stacks is new Yada.Stacks (Parsing_Level);
